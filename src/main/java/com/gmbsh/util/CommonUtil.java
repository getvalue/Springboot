...
import com.gmbsh.config.CommonJsonException;

import javax.servlet.http.HttpServletRequest;
import java.util.Enumeration;
import java.util.List;

import static com.gmbsh.util.StringUtil.isNullOrEmpty;
...
public class CommonUtil {
     ...
     * @return
     */
    public static PageData successpd(Object returnData) {
        PageData resultJson = new PageData();
        resultJson.put("returnCode", Const.SUCCESS_CODE);
        resultJson.put("returnMsg", Const.SUCCESS_MSG);
